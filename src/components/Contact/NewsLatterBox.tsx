...
const NewsLatterBox = () => {
  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-2xl bg-white p-6 sm:p-8 lg:p-6 xl:p-8">
      
      {/* Header */}
      <h3 className="mb-3 text-2xl font-bold leading-tight text-black dark:text-white">
      ...
      <p className="border-body-color/25 text-body-color mb-6 border-b pb-6 text-base leading-relaxed dark:border-white/25">
        Get weekly fitness tips, workout plans, and healthy recipes delivered straight to your inbox. 
        Join 5,000+ readers on their health journey.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          <input
            ...
            required
            className="border-stroke text-body-color focus:border-primary dark:text-body-color-dark dark:shadow-two dark:focus:border-primary mb-4 w-full rounded-lg border bg-[#f8f8f8] px-5 py-3 text-base outline-hidden dark:border-transparent dark:bg-[#2C303B] dark:focus:shadow-none"
          />
          <input
            type="email"
            name="email"
          ...
          <button
            ...
            className="bg-primary shadow-submit hover:bg-primary/90 dark:shadow-submit-dark mb-4 flex w-full cursor-pointer items-center justify-center rounded-lg px-5 py-3 text-base font-medium text-white duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? "Subscribing..." : "Subscribe Now →"}
          </button>
          <p className="text-body-color dark:text-body-color-dark text-center text-xs leading-relaxed">
