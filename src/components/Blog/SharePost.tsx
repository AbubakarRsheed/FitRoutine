  ...
  return (
    <>
      <a
        ...
        className="inline-flex items-center justify-center w-9 h-9 mb-3 ml-3 text-body-color bg-gray-light rounded-xs duration-300 hover:bg-primary hover:text-white dark:bg-gray-dark dark:hover:bg-primary"
      >
